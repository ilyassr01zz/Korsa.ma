...
export const createBooking = async (req, res) => {
    try {
        ...
        // Calculate price
        const totalPrice = calculatePrice(validatedData.departureCity, validatedData.destinationCity, validatedData.passengers);
        // Create or get user
        ...
        await sendBookingConfirmation(user.email, bookingNumber, validatedData.departureCity, validatedData.destinationCity, validatedData.departureDate, totalPrice);
        res.status(201).json({
